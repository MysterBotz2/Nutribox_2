...
class UsdaFoodReferenceService:
    ...
    def load_by_fdc_id(self, fdc_id: int, data_type: str = "USDA") -> Food | None:
        ...
        food = Food(
            ...
            phosphorus_mg_per_100g=detail.nutrients.get("phosphorus_mg"),
            vitamin_b6_mg_per_100g=detail.nutrients.get("vitamin_b6_mg"),
            niacin_mg_per_100g=detail.nutrients.get("niacin_mg"),
